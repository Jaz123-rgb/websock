...
*/
(function (a) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function (x) {
    a(x);
    a.Highcharts = x;
    return a;
    ...
    (function (a) {
      function y(c, e) {
        ...
        if (-1 < d) {
          ...
          d = Number(v[1]);
          c = "";
          if (e = u(v[0], e)) for (d = isNaN(d) ? e.length : d, d = 0 > d ? e.length + d : Math.min(d, e.length), v = 0; v < d; ++v) {
            c += b + e[v] + f;
          }
          return c.length ? c : "";
        }
        ...
        return -1 < f ? (b = c.substring(0, f), f = Number(c.substring(f + 1, v)), c = void 0, e = u(b, e), !isNaN(f) && e && (0 > f ? (c = e[e.length + f], "undefined" === typeof c && (c = e[0])) : (c = e[f], "undefined" === typeof c && (c = e[e.length - 1]))), "undefined" !== typeof c ? c : "") : "{" + c + "}";
      }

      function g(c, e, d) {
        var b = function b(_b, d) {
          _b = _b.slice(d || 0);
      ...
      function p(c, e) {
        ...
        for (var d = this.options.lang, b = 0; b < c.length; ++b) {
          d = d && d[c[b]];
        }
  ...
  x(a, "Accessibility/Utils/HTMLUtilities.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function (a, h) {
    ...
    function u(a, g) {
      ...
      if (q.createEvent) {
        ...
        if (y.initMouseEvent) return y.initMouseEvent(a, !0, !0, l, "click" === a ? 1 : 0, g.x, g.y, g.x, g.y, !1, !1, !1, !1, 0, null), y;
      }
    ...
    return {
      ...
      cloneMouseEvent: n,
      cloneTouchEvent: function cloneTouchEvent(a) {
        var g = function g(a) {
      ...
      escapeStringForHTML: function escapeStringForHTML(a) {
      ...
      getFakeMouseEvent: u,
      getHeadingTagNameForElement: function getHeadingTagNameForElement(a) {
        var g = function g(a) {
      ...
      removeClass: function removeClass(a, g) {
  ...
  x(a, "Accessibility/Utils/ChartUtilities.js", [a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, n) {
    ...
    return {
      ...
      getChartTitle: function getChartTitle(b) {
        return k(b.options.title.text || b.langFormat("accessibility.defaultChartTitle", {
          chart: b
        }));
      },
      getAxisDescription: function getAxisDescription(b) {
      ...
      getPointFromXY: function getPointFromXY(b, d, c) {
      ...
      getSeriesFromName: function getSeriesFromName(b, d) {
      ...
      hideSeriesFromAT: function hideSeriesFromAT(b) {
        (b = y(b)) && b.setAttribute("aria-hidden", !0);
      },
      scrollToPoint: function scrollToPoint(b) {
  ...
  x(a, "Accessibility/AccessibilityComponent.js", [a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/DOMElementProvider.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, n, u, q) {
  ...
  x(a, "Accessibility/FocusBorder.js", [a["Core/Renderer/SVG/SVGLabel.js"], a["Core/Utilities.js"]], function (a, h) {
    ...
    (function (h) {
      ...
      function p(b, d) {
        ...
        if ("text" === this.element.nodeName || D) {
          ...
          if (D) var t = {
            ...
            var m = t = 0;
            "middle" === this.attr("text-anchor") ? t = m = .5 : this.rotation ? t = .25 : m = .75;
            t = {
              x: t,
              y: m
            };
      ...
      function e(b) {
        b.focusBorderUpdateHooks && (Object.keys(b.focusBorderUpdateHooks).forEach(function (d) {
      ...
      h.compose = function (b, a) {
        -1 === d.indexOf(b) && (d.push(b), b = b.prototype, b.renderFocusBorder = l, b.setFocusToElement = y);
        -1 === d.indexOf(a) && (d.push(a), a = a.prototype, a.addFocusBorder = p, a.removeFocusBorder = c);
      };
    })(q || (q = {}));

    return q;
  });
  x(a, "Accessibility/Utils/Announcer.js", [a["Core/Renderer/HTML/AST.js"], a["Accessibility/Utils/DOMElementProvider.js"], a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, n, u, q) {
    var l = n.doc,
        w = u.addClass,
    ...
    return function () {
      ...
      p.prototype.createAnnouncerContainer = function () {
        var a = this.chart,
  ...
  x(a, "Accessibility/Components/InfoRegionsComponent.js", [a["Accessibility/A11yI18n.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/Components/AnnotationsA11y.js"], a["Core/Renderer/HTML/AST.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Core/Globals.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, n, u, q, l, G, y, g, p) {
    function k(b, a) {
      var d = a[0],
      ...
      if ("map" === d) return r.mapTitle ? b.langFormat("accessibility.chartTypes.mapTypeDescription", r) : b.langFormat("accessibility.chartTypes.unknownMap", r);
    ...
    return function (g) {
      ...
      t.prototype.getLongdescText = function () {
      ...
      t.prototype.getSonifyButtonText = function (b) {
        var a = this.chart;
      ...
      t.prototype.initSonifyButton = function (b) {
        ...
        d && c && (d.setAttribute("tabindex", -1), d.onclick = function (b) {
          (c.options.accessibility && c.options.accessibility.screenReaderSection.onPlayAsSoundClick || f).call(this, b, c);
        });
      };
      ...
      t.prototype.getAxesDescription = function () {
        var b = this.chart,
            a = function a(_a2, d) {
          _a2 = b[_a2];
          return 1 < _a2.length || _a2[0] && D(_a2[0].options.accessibility && _a2[0].options.accessibility.enabled, d);
        },
            d = !!b.types && 0 > b.types.indexOf("map") && 0 > b.types.indexOf("treemap") && 0 > b.types.indexOf("tilemap"),
  ...
  x(a, "Accessibility/Components/MenuComponent.js", [a["Core/Chart/Chart.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, n, u, q, l) {
    ...
    h = function (a) {
      ...
      c.prototype.proxyMenuButton = function () {
        var a = this.chart,
            ...
            k = a.exportSVGElements && a.exportSVGElements[0];
    ...
    (function (c) {
      ...
      function f() {
        if (this.exportDivElements) for (var a = this.exportDivElements.length; a--;) {
  ...
  x(a, "Accessibility/KeyboardNavigation.js", [a["Core/Globals.js"], a["Accessibility/Components/MenuComponent.js"], a["Core/Utilities.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, n, u, q) {
    var l = a.doc,
        w = a.win,
        y = n.addEvent,
        g = n.fireEvent,
    ...
    n = function () {
      ...
      a.prototype.getFirstValidModuleIx = function () {
        for (var a = this.modules.length, e = 0; e < a; ++e) {
          ...
          if (!d.validate || d.validate()) return e;
        }
    ...
    (function (k) {
      ...
      k.compose = function (a) {
        h.compose(a);
        -1 === d.indexOf(a) && (d.push(a), a.prototype.dismissPopupContent = c);
        -1 === d.indexOf(l) && (d.push(l), y(l, "keydown", e));
        return a;
      };
    })(n || (n = {}));
  ...
  x(a, "Accessibility/Components/LegendComponent.js", [a["Core/Animation/AnimationUtilities.js"], a["Core/Globals.js"], a["Core/Legend/Legend.js"], a["Core/Utilities.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, n, u, q, l, G, y) {
    function g(a) {
  ...
  x(a, "Accessibility/Components/SeriesComponent/SeriesDescriber.js", [a["Accessibility/Components/AnnotationsA11y.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Core/FormatUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Core/Utilities.js"]], function (a, h, n, u, q) {
    ...
    function d(a) {
      ...
      if (c) {
        ...
        z = (a.series.xAxis || {}).categories && m(a.category) && ("" + a.category).replace("<br/>", " ");
    ...
    return {
      ...
      describeSeries: function describeSeries(a) {
        var d = a.chart,
            c = L(a),
            e = x(a),
            m = d.is3d && d.is3d();
        ...
        if (e) {
          ...
          d.options3d && d.options3d.enabled && c || !(c || m || r || w(a)) ? e.removeAttribute("aria-label") : (d = a.chart.options.accessibility, c = d.landmarkVerbosity, (a.options.accessibility || {}).exposeAsGroupOnly ? e.setAttribute("role", "img") : "all" === c ? e.setAttribute("role", "region") : e.setAttribute("role", "group"), e.setAttribute("tabindex", "-1"), a.chart.styledMode || (e.style.outline = "none"), e.setAttribute("aria-label", C(d.series.descriptionFormatter && d.series.descriptionFormatter(a) || f(a))));
        }
      }
    };
  });
  x(a, "Accessibility/Components/SeriesComponent/NewDataAnnouncer.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Components/SeriesComponent/SeriesDescriber.js"]], function (a, h, n, u, q, l) {
    function w(a) {
    ...
    h = function () {
      ...
      d.prototype.addEventListeners = function () {
        ...
        c.addEvent(d, "afterApplyDrilldown", function () {
      ...
      d.prototype.queueAnnouncement = function (a, d, c) {
        ...
        if (e.enabled) {
          ...
          if (d = this.buildAnnouncementMessage(a, d, c)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
            time: f,
            message: d,
            series: a
      ...
      d.prototype.buildAnnouncementMessage = function (b, d, g) {
        ...
        if (v.announcementFormatter && (b = v.announcementFormatter(b, d, g), !1 !== b)) return b.length ? b : null;
  ...
  x(a, "Accessibility/ProxyElement.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"]], function (a, h, n, u, q) {
    var l = a.doc,
        w = h.attr,
        y = h.css,
        g = h.merge,
  ...
  x(a, "Accessibility/ProxyProvider.js", [a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/DOMElementProvider.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/ProxyElement.js"]], function (a, h, n, u, q, l) {
    var w = a.doc,
        y = h.attr,
        g = h.css,
    ...
    return function () {
      ...
      a.prototype.addProxyElement = function (a, b, c) {
        var d = this.groups[a];
        if (!d) throw Error("ProxyProvider.addProxyElement: Invalid group key " + a);
  ...
  x(a, "Extensions/RangeSelector.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Utilities.js"]], function (a, h, n, u, q, l) {
    function w(a) {
    ...
    var C = function () {
      ...
      f.prototype.clickButton = function (b, d) {
        ...
        if (null !== k && null !== h) {
          ...
          } else if (r) w = Math.max(t - r, k), t = Math.min(w + r, h), q = !1;else if ("ytd" === p) {
            if (m) {
      ...
      f.prototype.renderButtons = function () {
        ...
        [[n.isMS ? "mouseover" : "mouseenter"], [n.isMS ? "mouseout" : "mouseleave"], ["change", "click"]].forEach(function (d) {
          var c = d[0],
              e = d[1];
          g(t, c, function () {
        ...
        this.zoomText = e.label(c && c.rangeSelectorZoom || "", 0).attr({
      ...
      f.prototype.alignElements = function () {
        ...
        var p = g.inputPosition,
            v = g.verticalAlign,
            l = function l(b, d) {
          return t && a.titleCollision(c) && "top" === v && "right" === d.align && d.y - b.getBBox().height - 12 < (t.y || 0) + (t.height || 0) + c.spacing[0] ? -40 : 0;
        },
            q = c.plotLeft;
        ...
        if (e && h && p) {
          ...
          b = 0;
          f && (b = l(f, p), "left" === p.align ? n = q : "right" === p.align && (n = -Math.max(c.axisOffset[1], -b)), f.align({
            y: p.y,
          ...
          if ("top" === v) g.floating && (l = 0), c.titleOffset && c.titleOffset[0] && (l = c.titleOffset[0]), l += c.margin[0] - c.spacing[0] || 0;else if ("middle" === v) if (p.y === h.y) l = f;else if (p.y || h.y) l = 0 > p.y || 0 > h.y ? l - Math.min(p.y, h.y) : f - b;
      ...
      f.prototype.positionButtons = function () {
        ...
        this.buttonOptions.forEach(function (b, c) {
          if ("hidden" !== a[c].visibility) a[c][e]({
            x: k
          }), k += a[c].width + d.buttonSpacing;else a[c][e]({
            x: g
          });
        });
      };
      ...
      f.prototype.handleCollision = function (a) {
        ...
        e && c ? m.align === g.align || h(this.initialButtonGroupWidth + 20) ? "responsive" === k ? (this.collapseButtons(a), h(f()) && t()) : t() : "responsive" === k && this.expandButtons() : c && "responsive" === k && (this.initialButtonGroupWidth > d.plotWidth ? this.collapseButtons(a) : this.expandButtons());
      };
      ...
      f.prototype.destroy = function () {
        ...
        K(a, function (b, c) {
          b && "chart" !== c && (b instanceof q ? b.destroy() : b instanceof window.HTMLElement && d(b));
    ...
    a.prototype.minFromRange = function () {
      ...
      z(f) || (f = k);
      f <= k && (f = k, "undefined" === typeof g && (g = e(f, a.count)), this.newMax = Math.min(f + g, A(this.dataMax, Number.MAX_VALUE)));
    ...
    if (!n.RangeSelector) {
      var D = [],
        ...
        c && (f(D, function (b) {
          return b[0] === a;
        }) || D.push([a, [g(a.xAxis[0], "afterSetExtremes", function (a) {
  ...
  x(a, "Accessibility/Components/RangeSelectorComponent.js", [a["Extensions/RangeSelector.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/Announcer.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Core/Utilities.js"]], function (a, h, n, u, q, l) {
    ...
    h = function (a) {
      ...
      c.prototype.onButtonNavKbdArrowKey = function (a, b) {
        ...
        return e.highlightRangeSelectorButton(e.highlightedRangeSelectorItemIx + b) ? d.success : g ? (a.init(b), d.success) : d[0 < b ? "next" : "prev"];
      };
      ...
      c.prototype.initDropdownNav = function () {
        ...
        c && e && (b.setFocusToElement(c.buttonGroup, e), this.removeDropdownKeydownHandler && this.removeDropdownKeydownHandler(), this.removeDropdownKeydownHandler = p(e, "keydown", function (c) {
          ...
          (c.which || c.keyCode) === a.keyCodes.tab && (c.preventDefault(), c.stopPropagation(), d && (d.keyboardNavigation.tabindexContainer.focus(), d.keyboardNavigation.move(c.shiftKey ? -1 : 1)));
        }));
      };
    ...
    (function (c) {
      ...
      c.compose = function (c, g) {
        -1 === b.indexOf(c) && (b.push(c), c.prototype.highlightRangeSelectorButton = e);
        -1 === b.indexOf(g) && (b.push(g), p(a, "afterBtnClick", d));
      };
    })(h || (h = {}));
  ...
  x(a, "Accessibility/Components/SeriesComponent/SeriesKeyboardNavigation.js", [a["Core/Series/Point.js"], a["Core/Series/Series.js"], a["Core/Series/SeriesRegistry.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Utils/EventProvider.js"], a["Accessibility/Utils/ChartUtilities.js"]], function (a, h, n, u, q, l, x, y) {
    function g(a) {
      var b = a.index,
          c = a.series.points,
          d = c.length;
    ...
    n = function () {
      ...
      b.prototype.getKeyboardNavigationHandler = function () {
        ...
        return new l(f, {
          keyCodeMap: [[g ? [b.up, b.down] : [b.left, b.right], function (b) {
            ...
            f.highlightAdjacentSeries(a === b.pageDown);
            return this.response.success;
          }]],
          init: function init() {
      ...
      b.prototype.attemptHighlightAdjacentPoint = function (a, b) {
        ...
        return c.highlightAdjacentPoint(b) ? a.response.success : f && (b ? d(c) : e(c)) ? a.response.success : a.response[b ? "next" : "prev"];
      };
    ...
    (function (a) {
      ...
      a.compose = function (a, f, g) {
        -1 === m.indexOf(a) && (m.push(a), a = a.prototype, a.highlightAdjacentPoint = c, a.highlightAdjacentPointVertical = d, a.highlightAdjacentSeries = e);
  ...
  x(a, "Accessibility/Components/ZoomComponent.js", [a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Core/Utilities.js"]], function (a, h, n, u) {
    var q = this && this.__extends || function () {
      var _a7 = function a(g, k) {
    ...
    return function (a) {
      ...
      g.prototype.onChartUpdate = function () {
        ...
        a.mapNavigation && a.mapNavigation.navButtons.forEach(function (e, d) {
          l(a, e.element);
          c.setMapNavButtonAttrs(e.element, "accessibility.zoom.mapZoom" + (d ? "Out" : "In"));
        });
      };
      ...
      g.prototype.onMapKbdTab = function (a, c) {
        ...
        e.setFocusToElement(c.box, c.element);
        c.setState(2);
        return a.success;
      };
    ...
    function l(a) {
      ...
      a.series.forEach(function (k) {
        Object.keys(g).forEach(function (c) {
          var e,
              d = k.options[c];
          "accessibility.pointDescriptionFormatter" === c && (d = k.options.accessibility && k.options.accessibility.pointDescriptionFormatter);
  ...
  x(a, "Accessibility/Accessibility.js", [a["Core/DefaultOptions.js"], a["Core/Globals.js"], a["Core/Utilities.js"], a["Accessibility/A11yI18n.js"], a["Accessibility/Components/ContainerComponent.js"], a["Accessibility/FocusBorder.js"], a["Accessibility/Components/InfoRegionsComponent.js"], a["Accessibility/KeyboardNavigation.js"], a["Accessibility/Components/LegendComponent.js"], a["Accessibility/Components/MenuComponent.js"], a["Accessibility/Components/SeriesComponent/NewDataAnnouncer.js"], a["Accessibility/ProxyProvider.js"], a["Accessibility/Components/RangeSelectorComponent.js"], a["Accessibility/Components/SeriesComponent/SeriesComponent.js"], a["Accessibility/Components/ZoomComponent.js"], a["Accessibility/HighContrastMode.js"], a["Accessibility/HighContrastTheme.js"], a["Accessibility/Options/A11yDefaults.js"], a["Accessibility/Options/LangDefaults.js"], a["Accessibility/Options/DeprecatedOptions.js"]], function (a, h, n, u, q, l, x, y, g, p, k, c, e, d, b, f, v, z, L, K) {
    ...
    h = function () {
      ...
      a.prototype.init = function (a) {
        this.chart = a;
        w.addEventListener && a.renderer.isSVG ? (K(a), this.proxyProvider = new c(this.chart), this.initComponents(), this.keyboardNavigation = new y(a, this.components)) : (this.zombie = !0, this.components = {}, a.renderTo.setAttribute("aria-hidden", !0));
      };
    ...
    (function (a) {
      ...
      a.compose = function (a, m, r, t, w, v, x) {
        ...
        l.compose(m, v);
        x && e.compose(m, x);
        -1 === q.indexOf(m) && (q.push(m), m.prototype.updateA11yEnabled = h, A(m, "destroy", b), A(m, "render", c), A(m, "update", f), ["addSeries", "init"].forEach(function (a) {
          A(m, a, function () {
            this.a11yDirty = !0;
          });
        ...
        -1 === q.indexOf(t) && (q.push(t), A(t, "update", n));
        -1 === q.indexOf(w) && (q.push(w), ["update", "updatedData", "remove"].forEach(function (a) {
          A(w, a, function () {
  ...
  x(a, "masters/modules/accessibility.src.js", [a["Core/Globals.js"], a["Accessibility/Accessibility.js"], a["Accessibility/AccessibilityComponent.js"], a["Accessibility/Utils/ChartUtilities.js"], a["Accessibility/Utils/HTMLUtilities.js"], a["Accessibility/KeyboardNavigationHandler.js"], a["Accessibility/Components/SeriesComponent/SeriesDescriber.js"]], function (a, h, n, u, q, l, x) {
