...
*/
(function (a) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/export-data", ["highcharts", "highcharts/modules/exporting"], function (m) {
    a(m);
    a.Highcharts = m;
    return a;
  ...
  m(a, "Extensions/DownloadURL.js", [a["Core/Globals.js"]], function (a) {
    ...
    a = a.downloadURL = function (a, f) {
      ...
      if ("string" === typeof a || a instanceof String || !w.msSaveOrOpenBlob) {
        ...
        if (d && "string" === typeof a && 0 === a.indexOf("data:application/pdf") || w || 2E6 < a.length) if (a = r(a) || "", !a) throw Error("Failed to convert to blob");
        if ("undefined" !== typeof l.download) l.href = a, l.download = f, p.body.appendChild(l), l.click(), p.body.removeChild(l);else try {
  ...
  m(a, "Extensions/ExportData.js", [a["Core/Axis/Axis.js"], a["Core/Chart/Chart.js"], a["Core/Renderer/HTML/AST.js"], a["Core/Globals.js"], a["Core/DefaultOptions.js"], a["Core/Utilities.js"], a["Extensions/DownloadURL.js"]], function (a, d, c, p, f, r, y) {
    ...
    var w = this && this.__spreadArray || function (a, e, k) {
      if (k || 2 === arguments.length) for (var b = 0, z = e.length, g; b < z; b++) {
        !g && b in e || (g || (g = Array.prototype.slice.call(e, 0, b)), g[b] = e[b]);
      }
    ...
    d.prototype.getDataRows = function (b) {
      ...
      var f = E.categoryHeader,
        ...
        return q ? q instanceof a ? q.options.title && q.options.title.text || (q.dateTime ? P : f) : b ? {
      ...
      this.series.forEach(function (a) {
        ...
        if (!1 !== a.options.includeInDataExport && !a.options.isInternal && !1 !== a.visible) {
          ...
          for (f = 0; f < B;) {
            D = u(a, q[f], q.length), p.push(D.columnTitle || D), b && n.push(D.topLevelColumnTitle || D), f++;
          }
          ...
          a.options.data.forEach(function (b, u) {
            ...
            for (g[b].xValues[m] = v.x; f < B;) {
              u = q[f], c = v[u], g[b][A + f] = x(z.categoryMap[u][c], z.dateTimeValueAxisMap[u] ? k.dateFormat(d.dateFormat, c) : null, c), f++;
            }
          });
          A += f;
        }
      ...
      for (h in g) {
        Object.hasOwnProperty.call(g, h) && l.push(g[h]);
      }
      ...
      for (A = v.length; A--;) {
        ...
        l.forEach(function (a) {
          var b = a.name;
          m && !M(b) && (m.dateTime ? (a.x instanceof Date && (a.x = a.x.getTime()), b = k.dateFormat(d.dateFormat, a.x)) : b = m.categories ? x(m.names[a.x], m.categories[a.x], a.x) : a.x);
          a.splice(H, 0, b);
        });
      }
    ...
    d.prototype.getCSV = function (a) {
      ...
      k.forEach(function (a, e) {
        for (var c, l = a.length; l--;) {
          c = a[l], "string" === typeof c && (c = '"' + c + '"'), "number" === typeof c && "." !== d && (c = c.toString().replace(".", d)), a[l] = c;
        }
    ...
    d.prototype.getTableAST = function (a) {
      ...
      !1 !== d.exporting.tableCaption && c.push({
        ...
        textContent: x(d.exporting.tableCaption, d.title.text ? d.title.text : "Chart")
      });
      ...
      c.push(function (a, b, c) {
        ...
        if (b) {
          ...
          for (c = b.length; f < c; ++f) {
            "undefined" !== typeof b[f] && h.push(n("th", null, {
              scope: "col"
            }, b[f]));
          }
    ...
    d.prototype.toggleDataTable = function (a) {
      (a = x(a, !this.isDataTableVisible)) && !this.dataTableDiv && (this.dataTableDiv = l.createElement("div"), this.dataTableDiv.className = "highcharts-data-table", this.renderTo.parentNode.insertBefore(this.dataTableDiv, this.renderTo.nextSibling));
      ...
      b = this.options.lang;
      C && C.menuItemDefinitions && b && b.viewData && b.hideData && d && a && (a = a[d.indexOf("viewData")]) && c.setElementHTML(a, this.isDataTableVisible ? b.hideData : b.viewData);
    };
