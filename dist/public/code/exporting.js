...
*/
(function (a) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/exporting", ["highcharts"], function (g) {
    a(g);
    a.Highcharts = g;
    return a;
          ...
          if (r && 1 === d.nodeType && -1 === ca.indexOf(d.nodeName)) {
            ...
            for (var B in l) {
              if (p.isFirefox || p.isMS || p.isSafari || Object.hasOwnProperty.call(l, B)) {
                ...
                for (w = b.length; w-- && !h;) {
                  h = b[w].test(n) || "function" === typeof t;
                }
