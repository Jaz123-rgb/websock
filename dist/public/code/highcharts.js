...
*/
(function (Y, K) {
  "object" === (typeof module === "undefined" ? "undefined" : _typeof(module)) && module.exports ? (K["default"] = K, module.exports = Y.document ? K(Y) : K) : "function" === typeof define && define.amd ? define("highcharts/highcharts", function () {
    return K(Y);
  }) : (Y.Highcharts && Y.Highcharts.error(16, !0), Y.Highcharts = K(Y));
})("undefined" !== typeof window ? window : void 0, function (Y) {
  function K(f, e, l, C) {
  ...
  K(l, "Core/Utilities.js", [l["Core/Globals.js"]], function (f) {
    ...
    function G(a, c) {
      return !!a && "object" === _typeof(a) && (!c || !E(a));
    }
    ...
    function w(a, c, g) {
      for (var A in a) {
        Object.hasOwnProperty.call(a, A) && c.call(g || a[A], a[A], A, a);
      }
    }
    ...
    function x(a, c, g, m) {
      ...
      if (k.createEvent && (a.dispatchEvent || a.fireEvent && a !== f)) {
        ...
        for (var u = a, n = !1; u.hcEvents;) {
          Object.hasOwnProperty.call(u, "hcEvents") && u.hcEvents[c] && (A.length && (n = !0), A.unshift.apply(A, u.hcEvents[c])), u = Object.getPrototypeOf(u);
        }
    ...
    g = {
      addEvent: function addEvent(a, c, g, k) {
        void 0 === k && (k = {});
      ...
      correctFloat: n,
      createElement: function createElement(a, c, g, m, n) {
        a = k.createElement(a);
        c && b(a, c);
        n && q(a, {
          padding: "0",
      ...
      fireEvent: x,
      getMagnitude: r,
      getNestedProperty: function getNestedProperty(c, g) {
      ...
      normalizeTickInterval: function normalizeTickInterval(a, c, g, k, m) {
        var u = a;
        g = p(g, r(a));
        var A = a / g;
  ...
  K(l, "Core/Color/Color.js", [l["Core/Globals.js"], l["Core/Utilities.js"]], function (f, e) {
    ...
    e = function () {
      ...
      e.prototype.init = function (f) {
        var B;
        if ("object" === _typeof(f) && "undefined" !== typeof f.stops) this.stops = f.stops.map(function (d) {
          return new e(d[1]);
      ...
      e.prototype.brighten = function (e) {
        ...
        if (this.stops) this.stops.forEach(function (t) {
          t.brighten(e);
        });else if (l(e) && 0 !== e) for (var y = 0; 3 > y; y++) {
          B[y] += v(255 * e), 0 > B[y] && (B[y] = 0), 255 < B[y] && (B[y] = 255);
        }
        return this;
      };
  ...
  K(l, "Core/Time.js", [l["Core/Globals.js"], l["Core/Utilities.js"]], function (f, e) {
    ...
    e = function () {
      ...
      r.prototype.dateFormat = function (b, d, r) {
        ...
        y(p, function (a, c) {
          for (; -1 !== b.indexOf("%" + c);) {
            b = b.replace("%" + c, "function" === typeof a ? a.call(n, d) : a);
          }
        });
      ...
      r.prototype.getTimeTicks = function (d, r, p, q) {
        ...
        if (C(r)) {
          ...
          for (a = 1; r < p;) {
            m.push(r), r = g === b.year ? n.makeTime(A + a * c, 0) : g === b.month ? n.makeTime(A, q + a * c) : !D || g !== b.day && g !== b.week ? D && g === b.hour && 1 < c ? n.makeTime(A, q, u, z + a * c) : r + g * c : n.makeTime(A, q, u + a * c * (g === b.day ? 1 : 7)), a++;
          }
  ...
  K(l, "Core/Animation/Fx.js", [l["Core/Color/Color.js"], l["Core/Globals.js"], l["Core/Utilities.js"]], function (f, e, l) {
    ...
    return function () {
      ...
      e.prototype.run = function (y, t, h) {
        var d = this,
          ...
          setTimeout(b, 13);
            ...
            r = function r() {
          for (var b = 0; b < e.timers.length; b++) {
            e.timers[b]() || e.timers.splice(b--, 1);
          }
      ...
      e.prototype.initPath = function (e, t, h) {
        ...
        function b(b, m) {
          for (; b.length < z;) {
            if (m = b[Math.floor(b.length / n) - 1].slice(), "C" === m[0] && (m[1] = m[5], m[2] = m[6]), r) {
  ...
  K(l, "Core/Animation/AnimationUtilities.js", [l["Core/Animation/Fx.js"], l["Core/Utilities.js"]], function (f, e) {
    ...
    function C(b, d) {
      for (var p = f.timers.length; p--;) {
        f.timers[p].elem !== b || d && d !== f.timers[p].prop || (f.timers[p].stopped = !0);
      }
    }
    ...
    var v = e.defined,
        ...
        d = e.pick;
    return {
      animate: function animate(b, d, q) {
        var r,
            n = "",
            p,
            w;
      ...
      animObject: l,
      getDeferredAnimation: function getDeferredAnimation(b, d, q) {
        var r = l(d),
            n = 0,
            p = 0;
      ...
      setAnimation: function setAnimation(b, p) {
  ...
  K(l, "Core/FormatUtilities.js", [l["Core/DefaultOptions.js"], l["Core/Utilities.js"]], function (f, e) {
    ...
    var C = f.defaultOptions,
        ...
        y = e.pInt;
    return {
      dateFormat: function dateFormat(e, h, d) {
        return v.dateFormat(e, h, d);
      },
      format: function format(e, h, d) {
        var b = "{",
            p = !1,
            q = /f$/,
            r = /\.([0-9])/,
    ...
    (function (f) {
      function v(f, y, t) {
        ...
        for (f = f.map(function (b) {
          ...
          for (q = f.length; q--;) {
            d = f[q], b = (Math.min.apply(0, d.targets) + Math.max.apply(0, d.targets)) / 2, d.pos = e(b - d.size * d.align, 0, y - d.size);
          }

          q = f.length;

          for (r = !1; q--;) {
            0 < q && f[q - 1].pos + f[q - 1].size > f[q].pos && (f[q - 1].size += f[q].size, f[q - 1].targets = f[q - 1].targets.concat(f[q].targets), f[q - 1].align = .5, f[q - 1].pos + f[q - 1].size > y && (f[q - 1].pos = y - f[q - 1].size), f.splice(q, 1), r = !0);
          }
        }
  ...
  K(l, "Core/Renderer/SVG/SVGElement.js", [l["Core/Animation/AnimationUtilities.js"], l["Core/Renderer/HTML/AST.js"], l["Core/Color/Color.js"], l["Core/Globals.js"], l["Core/Utilities.js"]], function (f, e, l, C, v) {
    ...
    f = function () {
      ...
      f.prototype.destroy = function () {
        ...
        for (g.styledMode || a.destroyShadows(); k && k.div && 0 === k.div.childNodes.length;) {
          c = k.parentGroup, a.safeRemoveChild(k.div), delete k.div, k = c;
        }
      ...
      f.prototype.shadow = function (a, c, g) {
        var b = [],
          ...
          width: 3
            ...
            m = !1,
            F;
        !0 === a ? F = u : "object" === _typeof(a) && (F = x(u, a));
      ...
      f.prototype.updateShadows = function (a, c, g) {
        var b = this.shadows;
        if (b) for (var k = b.length; k--;) {
          g.call(b[k], "height" === a ? Math.max(c - (b[k].cutHeight || 0), 0) : "d" === a ? this.d : c, a, b[k]);
        }
      };
  ...
  K(l, "Core/Renderer/SVG/Symbols.js", [l["Core/Utilities.js"]], function (f) {
    ...
    return {
      arc: e,
      callout: function callout(e, f, t, h, d) {
      ...
      circle: function circle(f, l, t, h) {
      ...
      diamond: function diamond(e, f, t, h) {
        return [["M", e + t / 2, f], ["L", e + t, f + h / 2], ["L", e + t / 2, f + h], ["L", e, f + h / 2], ["Z"]];
      },
      rect: l,
      roundedRect: C,
      square: l,
      triangle: function triangle(e, f, t, h) {
        return [["M", e + t / 2, f], ["L", e + t, f + h], ["L", e, f + h], ["Z"]];
      },
      "triangle-down": function triangleDown(e, f, t, h) {
    ...
    return function () {
      ...
      d.prototype.modifyDOM = function () {
        ...
        for (var r; r = d.element.firstChild;) {
          if (/^[\s\u200B]*$/.test(r.textContent || " ")) d.element.removeChild(r);else break;
        }
        ...
        if (n) {
          var h = function h(r, p) {
            ...
            if (b.ellipsis) m && b.truncate(r, m, void 0, 0, Math.max(0, n - parseInt(b.fontSize || 12, 10)), function (a, c) {
              ...
              for (a = []; p.firstChild && p.firstChild !== r;) {
                a.push(p.firstChild), p.removeChild(p.firstChild);
              }

              for (; k.length;) {
                k.length && !b.noWrap && 0 < c && (m.push(r.textContent || ""), r.textContent = k.join(" ").replace(/- /g, "-")), b.truncate(r, void 0, k, 0 === c ? D || 0 : 0, n, function (a, c) {
      ...
      d.prototype.truncate = function (b, d, e, r, n, h) {
        ...
        if (r + A > n) {
          for (; k <= a;) {
            g = Math.ceil((k + a) / 2), e && (c = h(e, g)), A = D(g, c && c.length - 1), k === a ? k = a + 1 : A > n ? a = g - 1 : k = g;
          }
  ...
  K(l, "Core/Renderer/SVG/SVGRenderer.js", [l["Core/Renderer/HTML/AST.js"], l["Core/Color/Color.js"], l["Core/Globals.js"], l["Core/Renderer/RendererRegistry.js"], l["Core/Renderer/SVG/SVGElement.js"], l["Core/Renderer/SVG/SVGLabel.js"], l["Core/Renderer/SVG/Symbols.js"], l["Core/Renderer/SVG/TextBuilder.js"], l["Core/Utilities.js"]], function (f, e, l, C, v, E, G, B, y) {
    ...
    l = function () {
      ...
      I.prototype.init = function (a, c, g, m, u, F, I) {
        ...
        this.setSize(c, g, !1);
        var e;
        b && a.getBoundingClientRect && (c = function c() {
          k(a, {
            left: 0,
            top: 0
          });
      ...
      I.prototype.text = function (c, g, b, d) {
        ...
        if (!d || this.forExport && !this.allowHTML) c.xSetter = function (a, c, g) {
          for (var b = g.getElementsByTagName("tspan"), d = g.getAttribute(c), k = 0, m; k < b.length; k++) {
            m = b[k], m.getAttribute(c) === d && m.setAttribute(c, a);
          }
      ...
      I.prototype.pathToSegments = function (a) {
        for (var c = [], g = [], b = {
          ...
          L(g[0]) && A(a[d]) && g.length === b[g[0].toUpperCase()] && a.splice(d, 0, g[0].replace("M", "L").replace("m", "l")), "string" === typeof a[d] && (g.length && c.push(g.slice(0)), g.length = 0), g.push(a[d]);
        }
    ...
    f = function () {
      ...
      f.prototype.defaultLabelFormatter = function (c) {
        ...
        var u = b.logarithmic ? Math.abs(g) : b.tickInterval,
            h = m && m.length;
        if (b.categories) var f = "".concat(this.value);else if (k) f = d.dateFormat(k, g);else if (h && 1E3 <= u) for (; h-- && "undefined" === typeof f;) {
          b = Math.pow(e, h + 1), u >= b && 0 === 10 * g % b && null !== m[h] && 0 !== g && (f = c(g / b, -1) + m[h]);
        }
      ...
      f.prototype.getMinorTickPositions = function () {
        ...
        if (k && k / g < this.len / 3) {
          ...
          });else if (this.dateTime && "auto" === this.getMinorTickInterval()) m = m.concat(this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(g), d, b, a.startOfWeek));else for (a = d + (c[0] - d) % g; a <= b && a !== m[0]; a += g) {
            m.push(a);
          }
        }
      ...
      f.prototype.setTickPositions = function () {
        ...
        if (!g) {
          if (this.ordinal && this.ordinal.positions || !((this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200))) {
            if (this.dateTime) g = this.getTimeTicks(this.dateTime.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinal && this.ordinal.positions, this.closestPointRange, !0);else if (this.logarithmic) g = this.logarithmic.getLogTickPositions(this.tickInterval, this.min, this.max);else for (var e = a = this.tickInterval; e <= 2 * a;) {
              if (g = this.getLinearTickPositions(this.tickInterval, this.min, this.max), this.tickAmount && g.length > this.tickAmount) this.tickInterval = U(this, e *= 1.1);else break;
            }
      ...
      f.prototype.trimTicks = function (a, c, g) {
        ...
        if (!this.isLinked) {
          if (c && -Infinity !== b) this.min = b;else for (; this.min - k > a[0];) {
            a.shift();
          }
          if (g) this.max = d;else for (; this.max + k < a[a.length - 1];) {
            a.pop();
          }
        ...
        if (c.hasData() && a(d) && a(b)) {
          ...
          if (a(D) && a(c.threshold)) {
            for (; m[D] !== p || m.length !== e || m[0] > d || m[m.length - 1] < b;) {
              ...
              for (m.push(c.threshold); m.length < e;) {
                void 0 === m[D] || m[D] > c.threshold ? m.unshift(r(m[0] - A)) : m.push(r(m[m.length - 1] + A));
              }
            ...
            for (; m.length < e;) {
              m.length % 2 || d === p ? m.push(r(m[m.length - 1] + A)) : m.unshift(r(m[0] - A));
            }
          ...
          if (n(g)) {
            for (A = p = m.length; A--;) {
              (3 === g && 1 === A % 2 || 2 >= g && 0 < A && A < p - 1) && m.splice(A, 1);
            }
      ...
      f.prototype.remove = function (a) {
        for (var c = this.chart, g = this.coll, b = this.series, d = b.length; d--;) {
          b[d] && b[d].remove(!1);
        }
  ...
  K(l, "Core/Series/Point.js", [l["Core/Renderer/HTML/AST.js"], l["Core/Animation/AnimationUtilities.js"], l["Core/DefaultOptions.js"], l["Core/FormatUtilities.js"], l["Core/Utilities.js"]], function (f, e, l, C, v) {
    ...
    e = function () {
      ...
      g.prototype.firePointEvent = function (a, g, d) {
        ...
        "click" === a && k.allowPointSelect && (d = function d(a) {
      ...
      g.prototype.optionsToObject = function (a) {
        var c = this.series,
            ...
            m = 0,
            f = 0;
        if (n(a) || null === a) e[d[0]] = a;else if (q(a)) for (!b && a.length > k && (c = _typeof(a[0]), "string" === c ? e.name = a[0] : "number" === c && (e.x = a[0]), m++); f < k;) {
          b && "undefined" === typeof a[m] || (0 < d[f].indexOf(".") ? g.prototype.setNestedProperty(e, a[m], d[f]) : e[d[f]] = a[m]), m++, f++;
        } else "object" === _typeof(a) && (e = a, a.dataLabels && (c._hasPointLabels = !0), a.marker && (c._hasPointMarkers = !0));
        return e;
      };
  ...
  K(l, "Core/Chart/Chart.js", [l["Core/Animation/AnimationUtilities.js"], l["Core/Axis/Axis.js"], l["Core/FormatUtilities.js"], l["Core/Foundation.js"], l["Core/Globals.js"], l["Core/Legend/Legend.js"], l["Core/MSPointer.js"], l["Core/DefaultOptions.js"], l["Core/Pointer.js"], l["Core/Renderer/RendererRegistry.js"], l["Core/Series/SeriesRegistry.js"], l["Core/Renderer/SVG/SVGRenderer.js"], l["Core/Time.js"], l["Core/Utilities.js"], l["Core/Renderer/HTML/AST.js"]], function (f, e, l, C, v, E, G, B, y, t, h, d, b, p, q) {
    ...
    f = function () {
      ...
      f.prototype.redraw = function (a) {
        ...
        if (F) for (a = b.length; a--;) {
          n = b[a], n.options.stacking && (n.isDirty = !0);
        }
        b.forEach(function (a) {
      ...
      f.prototype.get = function (a) {
        ...
        for (var b = this.series, d = da(this.axes, c) || da(this.series, c), g = 0; !d && g < b.length; g++) {
          d = da(b[g].points || [], c);
        }
      ...
      f.prototype.temporaryDisplay = function (a) {
        var c = this.renderTo;
        if (a) for (; c && c.style;) {
          c.hcOrigStyle && (M(c, c.hcOrigStyle), delete c.hcOrigStyle), c.hcOrigDetached && (m.body.removeChild(c), c.hcOrigDetached = !1), c = c.parentNode;
        } else for (; c && c.style;) {
      ...
      f.prototype.getContainer = function () {
        ...
        if (this.styledMode) for (var p in c.defs) {
          this.renderer.definition(c.defs[p]);
      ...
      f.prototype.propFromSeries = function () {
        ...
        ["inverted", "angular", "polar"].forEach(function (f) {
          ...
          for (d = b && b.length; !e && d--;) {
            (g = A[b[d].type]) && g.prototype[f] && (e = !0);
          }
    ...
    f = function () {
      ...
      e.prototype.findPointIndex = function (a, c) {
        var b = a.id,
            ...
            f,
            k;
        if (b) e = this.chart.get(b), e instanceof E && (f = e);else if (this.linkedParent || this.enabledDataSorting || this.options.relativeXValue) if (f = function f(c) {
          return !c.touched && c.index === a.index;
        }, e && e.matchByName ? f = function f(c) {
          return !c.touched && c.name === a.name;
        } : this.options.relativeXValue && (f = function f(c) {
      ...
      e.prototype.updateData = function (a, c) {
        ...
        if (m) for (a = e.length; a--;) {
          (n = e[a]) && !n.touched && n.remove && n.remove(!1, c);
      ...
      e.prototype.setData = function (a, c, b, d) {
        ...
        if (!u) {
          ...
          if (p && x > p) {
            if (w = g.getFirstValidPoint(a), M(w)) for (b = 0; b < x; b++) {
              l[b] = this.autoIncrement(), r[b] = a[b];
            } else if (R(w)) {
              if (q) {
                if (w.length === q) for (b = 0; b < x; b++) {
                  l[b] = this.autoIncrement(), r[b] = a[b];
                } else for (b = 0; b < x; b++) {
                  d = a[b], l[b] = d[0], r[b] = d.slice(1, q + 1);
                }
              } else if (F && (t = F.indexOf("x"), z = F.indexOf("y"), t = 0 <= t ? t : 0, z = 0 <= z ? z : 1), 1 === w.length && (z = 0), t === z) for (b = 0; b < x; b++) {
                l[b] = this.autoIncrement(), r[b] = a[b][z];
              } else for (b = 0; b < x; b++) {
                d = a[b], l[b] = d[t], r[b] = d[z];
              }
            } else D(12, !1, h);
          } else for (b = 0; b < x; b++) {
            "undefined" !== typeof a[b] && (d = {
              series: g
      ...
      e.prototype.getProcessedData = function (a) {
        ...
        for (d = k.length || 1; --d;) {
          if (c = b ? a(k[d]) - a(k[d - 1]) : k[d] - k[d - 1], 0 < c && ("undefined" === typeof u || c < u)) var u = c;else 0 > c && m && !n && (D(15, !1, this.chart), m = !1);
        }
      ...
      e.prototype.generatePoints = function () {
        ...
        this.options.keys = h;
        if (l && (e !== (n = l.length) || k)) for (p = 0; p < n; p++) {
          p !== f || k || (p += e), l[p] && (l[p].destroyElements(), l[p].plotX = void 0);
        }
        this.data = l;
        this.points = m;
      ...
      e.prototype.getFirstValidPoint = function (a) {
        for (var c = a.length, b = 0, d = null; null === d && b < c;) {
          d = a[b], b++;
        }
      ...
      e.prototype.addPoint = function (a, c, b, d, g) {
        ...
        var q = l.x;
        var r = n.length;
        if (this.requireSorting && q < n[r - 1]) for (p = !0; r && n[r - 1] > q;) {
          r--;
        }
      ...
      d.prototype.getStackPoints = function (b) {
        ...
        if (this.options.stacking) {
          for (var g = 0; g < b.length; g++) {
            b[g].leftNull = b[g].rightNull = void 0, z[b[g].x] = b[g];
          }
    ...
    (function (e) {
      ...
      function z(b, a) {
        ...
        if (y(b) && !y(a)) d = b.map(function (b) {
          ...
          return t(b, a);
        });else if (y(b) || y(a)) for (c = Math.max(b.length, a.length); c--;) {
          d[c] = t(b[c], a[c]);
        } else d = t(b, a);
        return d;
      }
  ...
  K(l, "Series/CenteredUtilities.js", [l["Core/Globals.js"], l["Core/Series/Series.js"], l["Core/Utilities.js"]], function (f, e, l) {
    ...
    (function (f) {
      f.getCenter = function () {
        ...
        for (r = 0; 4 > r; ++r) {
          w = f[r], d = 2 > r || 2 === r && /%$/.test(w), f[r] = B(w, [l, q, n, f[2]][r]) + (d ? b : 0);
        }
  ...
  K(l, "Series/Pie/PieSeries.js", [l["Series/CenteredUtilities.js"], l["Series/Column/ColumnSeries.js"], l["Core/Globals.js"], l["Core/Legend/LegendSymbol.js"], l["Series/Pie/PiePoint.js"], l["Core/Series/Series.js"], l["Core/Series/SeriesRegistry.js"], l["Core/Renderer/SVG/Symbols.js"], l["Core/Utilities.js"]], function (f, e, l, C, v, E, G, B, y) {
    ...
    y = function (b) {
      ...
      e.prototype.updateTotals = function () {
        ...
        for (f = 0; f < d; f++) {
          g = b[f], g.percentage = 0 < a && (g.visible || !e) ? g.y / a * 100 : 0, g.total = a;
        }
      };
  ...
  K(l, "Series/Pie/PieDataLabel.js", [l["Core/Series/DataLabel.js"], l["Core/Globals.js"], l["Core/Renderer/RendererUtilities.js"], l["Core/Series/SeriesRegistry.js"], l["Core/Utilities.js"]], function (f, e, l, C, v) {
    ...
    (function (e) {
      ...
      var v = [],
        ...
        radialDistributionX: function radialDistributionX(b, d, a, e) {
          return b.getX(a < d.top + 2 || a > d.bottom - 2 ? e : a, d.half, d);
        },
        justify: function justify(b, d, a) {
          return a[0] + (b.half ? -1 : 1) * (d + b.labelDistance);
        },
        alignToPlotEdges: function alignToPlotEdges(b, d, a, e) {
          b = b.getBBox().width;
          return d ? b + e : a - b - e;
        },
        alignToConnectors: function alignToConnectors(b, d, a, e) {
          var c = 0,
              f;
          b.forEach(function (a) {
  ...
  K(l, "Extensions/OverlappingDataLabels.js", [l["Core/Chart/Chart.js"], l["Core/Utilities.js"]], function (f, e) {
    ...
    C(f, "render", function () {
      ...
      (this.series || []).forEach(function (d) {
        ...
        d.visible && (!1 !== b.enabled || d._hasPointLabels) && (b = function b(_b6) {
          return _b6.forEach(function (b) {
      ...
      var f = function () {
        ...
        b.prototype.currentOptions = function (b) {
          function d(b, f, h, k) {
            var a;
            G(b, function (b, c) {
              if (!k && -1 < e.collectionsWithUpdate.indexOf(c) && f[c]) for (b = y(b), h[c] = [], a = 0; a < Math.max(b.length, f[c].length); a++) {
                f[c][a] && (void 0 === b[a] ? h[c][a] = f[c][a] : (h[c][a] = {}, d(b[a], f[c][a], h[c][a], k + 1)));
